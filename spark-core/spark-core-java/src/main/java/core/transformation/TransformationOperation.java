...
public class TransformationOperation {
	...
	private static void groupByKey() {
		...
		//JavaPairRDD<String, Integer> scores = sc.parallelizePairs(scoreList);
		 JavaPairRDD<String, Integer>  scores =  (JavaPairRDD<String,Integer>) sc.parallelizePairs(scoreList);
	...
	private static void reduceByKey() {
		...
		// 并行化集合，创建JavaPairRDD
		JavaPairRDD<String, Integer> scores = sc.<String, Integer>parallelizePairs(scoreList);
	...
	private static void sortByKey() {
		...
		// 并行化集合，创建RDD
		JavaPairRDD<Integer, String> scores = sc.<Integer, String>parallelizePairs(scoreList);
	...
	private static void join() {
		...
		// 并行化两个RDD
		JavaPairRDD<Integer, String> students = sc.<Integer, String>parallelizePairs(studentList);
		...
		JavaPairRDD<Integer, Tuple2<String, Integer>> studentScores = students.<Integer>join(scores);
	...
	private static void cogroup() {
		...
		JavaPairRDD<Integer, Tuple2<Iterable<String>, Iterable<Integer>>> studentScores =
				students.<Integer>cogroup(scores);
